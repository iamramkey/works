...
// doc: generators will behave like a function so we can assign it to a variable, use it under a function, etc...
/*

doc: old way of creating object
var iteratorObj = {
	myIterator : function *(items){
		for (var i = 0; i < items.length; i++) yield items[i];
	}
};

var es6Iterator = iteratorObj.myIterator([1, 2, 3, 4, 5, 6]);
console.log(es6Iterator.next()); // { done: false, value: 1 }
console.log(es6Iterator.next()); // { done: false, value: 2 }
console.log(es6Iterator.next()); // { done: false, value: 3 }
console.log(es6Iterator.next()); // { done: false, value: 4 }
...
doc: es6 way of creating an iterator in an object
...
var es6Iterator = es6IteratorObj.myIterator([1, 2, 3, 4, 5, 6]);
console.log(es6Iterator.next()); // { done: false, value: 1 }
console.log(es6Iterator.next()); // { done: false, value: 2 }
console.log(es6Iterator.next()); // { done: false, value: 3 }
console.log(es6Iterator.next()); // { done: false, value: 4 }
