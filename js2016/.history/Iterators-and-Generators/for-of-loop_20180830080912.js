...
console.log('TCL: isIterable([])', isIterable([]));
console.log('TCL: isIterable({})', isIterable({}));
console.log('TCL: isIterable("")', isIterable(''));
console.log('TCL: isIterable(new Set())', isIterable(new Set()));
console.log('TCL: isIterable(new WeakSet())', isIterable(new WeakSet()));
console.log('TCL: isIterable(new Map())', isIterable(new Map()));
console.log('TCL: isIterable(new WeakMap())', isIterable(new WeakMap()));
