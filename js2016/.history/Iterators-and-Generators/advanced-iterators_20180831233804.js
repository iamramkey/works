...
console.log('TCL: iterator4.next()', iterator4.next()); // 
console.log('TCL: iterator4.next()', iterator4.next()); // 
console.log('TCL: iterator4.next()', iterator4.next()); // 
console.log('TCL: iterator4.next()', iterator4.next()); // 
console.log('TCL: iterator4.next()', iterator4.next()); // 
...
TCL: iterator4.next() { value: 1, done: false }
TCL: iterator4.next() { value: 2, done: false }
TCL: iterator4.next() { value: 'for loop in generatorUsingForLoop with count : 3 with increment value : 0',   done: false }
TCL: iterator4.next() { value: 'for loop in generatorUsingForLoop with count : 3 with increment value : 1',  done: false }
TCL: iterator4.next() { value: 'for loop in generatorUsingForLoop with count : 3 with increment value : 2',  done: false }
TCL: iterator4.next() { value: 'final value', done: false }
TCL: iterator4.next() { value: undefined, done: true }
TCL: iterator4.next() { value: undefined, done: true }
