...
var price = 0.25,
	itemsCount = 10,
	priceMessage = `Individual item price is : ${price}. So total cost for ${itemsCount} items is : ${price *
		itemsCount}`;
console.log(priceMessage); // Individual item price is : 0.25. So total cost for 10 items is : 2.5

// backtick string in a back tick string substitution

var backTickGreeting = `${greeting}, ${` My name is ${name}`} `;
console.log(backTickGreeting); // Hello,  My name is Iamramkey
