...
class DynamicPropertyContainer {
	...
	static staticMethod(){
		console.log('static Method of DynamicPropertyContainer is called');
	}
}

var dynamicClassObject = new DynamicPropertyContainer('<p></p>');

console.log('TCL: dynamicClassObject[dynamicPropertyForAClass]()', dynamicClassObject[dynamicPropertyForAClass]);
console.log(DynamicPropertyContainer.staticMethod());
