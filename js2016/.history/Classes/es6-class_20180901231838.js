...
let descriptor = Object.getOwnPropertyDescriptor(
	InnerHTMLModifier.prototype,
	'html'
);

console.log(`TCL: 'get' in descriptor`, 'get' in descriptor); // TCL: 'get' in descriptor true
console.log(`TCL: 'set' in descriptor`, 'set' in descriptor); // TCL: 'set' in descriptor true
console.log('TCL: descriptor.enumerable', descriptor.enumerable); // TCL: descriptor.enumerable false

let dynamicPropertyForAClass = 'printOuterHTMl';
let dynamicSetterAndGetterVariableName = 'html';
class DynamicPropertyContainer {
	constructor(html) {
		this.element = html;
	}
	[dynamicPropertyForAClass]() {
		return this.element;
	}
	set [dynamicSetterAndGetterVariableName](val) {
		console.log('in dynamic name setter method with value: ', val);
	}
	get [dynamicSetterAndGetterVariableName]() {
		console.log('In dynamic name getter method');
	}
	// doc:: in es6 we can create only static method, but in es7 we can have static variables defined
	static staticMethod() {
		return 'static Method of DynamicPropertyContainer is called';
	}
}

var dynamicClassObject = new DynamicPropertyContainer('<p></p>');

console.log(
	'TCL: dynamicClassObject[dynamicPropertyForAClass]()',
	dynamicClassObject[dynamicPropertyForAClass]()
); // TCL: dynamicClassObject[dynamicPropertyForAClass]() <p></p>
console.log(DynamicPropertyContainer.staticMethod()); // static Method of DynamicPropertyContainer is called
