...
let anonObject = createObjectByProvidedClass(
	class {
		...
		sayHi() {
			console.log(' sayHi from anonymous class ');
		}
	}
);
...
let anon1Object = new class {
	...
	sayHi() {
		console.log(' sayHi from annonymous class with params ', this.name);
	}
}('AnotherClass');

console.log('TCL: anon1Object.sayHi();', anon1Object.sayHi(););
