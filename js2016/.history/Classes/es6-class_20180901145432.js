...
let anonObject = createObjectByProvidedClass(
	class {
		...
		sayHi() {
			retun ' sayHi from anonymous class ';
		}
	}
);

console.log('TCL: anonObject.sayHi();', anonObject.sayHi());
...
console.log('TCL: anon1Object.sayHi();', anon1Object.sayHi()); // TCL: anonObject.sayHi(); undefined
 sayHi from annonymous class with params  AnotherClass
